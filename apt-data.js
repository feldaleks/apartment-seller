...
const apartments = [
    ...
    },
    {
        ...
        parking: true,
        immediate: false,
        features: ["AC", "Indorr Plubming", "Elevator", "Terasse"],
        contactDetails: {
            name: "William",
            email: "will@i.am"
        }
    ...
    },
    {
        ...
        parking: true,
        immediate: true,
        features: ["AC", "Indorr Plubming", "Terasse"],
        contactDetails: {
            name: "Trevor",
            email: "t@noah.ark"
        }
